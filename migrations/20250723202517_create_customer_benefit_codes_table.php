...
final class CreateCustomerBenefitCodesTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('customer_benefit_codes');
        $table->addColumn('customer_id', 'integer')
            ->addColumn('code_customer', 'string')
            ->addColumn('code_be', 'string')
