...
final class CreateBancoPadraoTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('banco_padrao');
        $table
            ->addColumn('bank_id', 'integer', ['default' => 1])
        ...
        $this->table('banco_padrao')->insert($rows)->saveData();
    }
}
