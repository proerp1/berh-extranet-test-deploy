...
final class CreateOrderDocumentos extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('order_documentos');
        $table->addColumn('order_id', 'integer', ['null' => false])
              ->addColumn('name', 'string')
              ->addColumn('file_name', 'string', ['null' => false])
              ->addColumn('status_id', 'integer', ['null' => false])
              ->addColumn('created', 'datetime')
              ->addColumn('user_created_id', 'integer', ['null' => true])
