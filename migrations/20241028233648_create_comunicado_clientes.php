...
final class CreateComunicadoClientes extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('comunicado_customers');
        $table->addColumn('comunicado_id', 'integer', ['null' => false])
              ->addColumn('customer_id', 'integer', ['null' => false])
              ->addColumn('sent', 'datetime')
              ->addColumn('user_sent_id', 'integer')
