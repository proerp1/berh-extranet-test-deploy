...
class BankAccountsController extends AppController
{
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->BankAccount->validates()) {
                ...
                if ($this->BankAccount->save($this->request->data)) {
                    $this->Flash->set(__('A conta bancária foi salva com sucesso'), ['params' => ['class' => "alert alert-success"]]);
                    $this->redirect(['action' => 'edit/'.$this->BankAccount->id]);
                } else {
                    $this->Flash->set(__('A conta bancária não pode ser salva, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
                }
            } else {
                $this->Flash->set(__('A conta bancária não pode ser salva, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->BankAccount->save($this->request->data)) {
                $this->Flash->set(__('A conta bancária foi alterada com sucesso'), ['params' => ['class' => "alert alert-success"]]);
            } else {
                $this->Flash->set(__('A conta bancária não pode ser alterada, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->BankAccount->save($this->request->data)) {
            $this->Flash->set(__('A conta bancária foi excluida com sucesso'), ['params' => ['class' => "alert alert-success"]]);
