...
class DepartmentsController extends AppController
{
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Department->validates()) {
                ...
                if ($this->Department->save($this->request->data)) {
                    $this->Session->setFlash(__('O departamento foi salvo com sucesso'), 'default', ['class' => "alert alert-success"]);
                    $this->redirect(['action' => 'index']);
                } else {
                    $this->Session->setFlash(__('O departamento não pode ser salvo, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
                }
            } else {
                $this->Session->setFlash(__('O departamento não pode ser salvo, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
            }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Department->save($this->request->data)) {
                $this->Session->setFlash(__('O departamento foi alterado com sucesso'), 'default', ['class' => "alert alert-success"]);
                $this->redirect(['action' => 'index']);
            } else {
                $this->Session->setFlash(__('O departamento não pode ser alterado, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
            }
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->Department->save($this->request->data)) {
            $this->Session->setFlash(__('O departamento foi excluidi com sucesso'), 'default', ['class' => "alert alert-success"]);
            $this->redirect(['action' => 'index']);
        }
    }
}
