...
class IncomesController extends AppController
{
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Income->validates()) {
                ...
                if ($this->Income->save($this->request->data)) {
                    ...
                    $this->Session->setFlash(__('A conta a receber foi salva com sucesso'), 'default', ['class' => "alert alert-success"]);
                    $this->redirect(['action' => 'index/?'.$this->request->data['query_string']]);
                } else {
                    $this->Session->setFlash(__('A conta a receber não pode ser salva, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
                }
            } else {
                $this->Session->setFlash(__('A conta a receber não pode ser salva, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
            }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Income->save($this->request->data)) {
                ...
                $this->Session->setFlash(__('A conta a receber foi alterada com sucesso'), 'default', ['class' => "alert alert-success"]);
                $this->redirect(['action' => 'index/?'.$this->request->data['query_string']]);
            } else {
                $this->Session->setFlash(__('A conta a receber não pode ser alterada, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
            }
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->Income->save($data)) {
            $this->Session->setFlash(__('A conta a receber foi excluida com sucesso'), 'default', ['class' => "alert alert-success"]);
    ...
    ********************/
    ...
    public function envia_email($id)
    {
        ...
        if (empty($response)) {
        	$this->Session->setFlash(__('Enviado com sucesso'), 'default', ['class' => "alert alert-success"]);
        } else {
        	$this->Session->setFlash(__('Houve um problema'), 'default', ['class' => "alert alert-danger"]);
        }
