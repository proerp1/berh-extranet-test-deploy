...
class OrdersController extends AppController
{
    ...
    public function index()
    {
        ...
        if (isset($_GET['q']) and $_GET['q'] != "") {
            $condition['or'] = array_merge($condition['or'], ['Order.id' => $_GET['q'], 'Customer.nome_primario LIKE' => "%" . $_GET['q'] . "%", 'EconomicGroup.name LIKE' => "%" . $_GET['q'] . "%",  'Customer.id LIKE' => "%" . $_GET['q'] . "%"]);
        }
        ...
        $customers = $this->Customer->find('list', ['fields' => ['id', 'nome_primario'], ['conditions' => ['Customerw.status_id' => 3]], 'order' => ['nome_primario' => 'asc']]);
