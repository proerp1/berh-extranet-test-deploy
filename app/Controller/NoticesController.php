...
class NoticesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Notice->save($this->request->data)) {
                $this->Flash->set(__('O aviso foi salvo com sucesso'), ['params' => ['class' => "alert alert-success"]]);
                $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->set(__('O aviso não pode ser salvo, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Notice->save($this->request->data)) {
                $this->Flash->set(__('O aviso foi alterado com sucesso'), ['params' => ['class' => "alert alert-success"]]);
                $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->set(__('O aviso não pode ser alterado, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->Notice->save($this->request->data)) {
            $this->Flash->set(__('O aviso foi excluido com sucesso'), ['params' => ['class' => "alert alert-success"]]);
            $this->redirect(['action' => 'index']);
        }
    }
}
