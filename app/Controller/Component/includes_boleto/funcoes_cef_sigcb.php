...
$nossonumero_formatado = $nnum . '-' .digitoVerificador_nossonumero($nnum);
...
//Guarda inicial
?><img src=<?php echo $link ?>/img/boleto_imgs/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $link ?>/img/boleto_imgs/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $link ?>/img/boleto_imgs/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $link ?>/img/boleto_imgs/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=<?php echo $link ?>/img/boleto_imgs/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=<?php echo $link ?>/img/boleto_imgs/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=<?php echo $link ?>/img/boleto_imgs/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=<?php echo $link ?>/img/boleto_imgs/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $link ?>/img/boleto_imgs/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função

// by guilherme
function fbarcode2($valor, $link){
  $fino = 1 ;
  $largo = 3 ;
  $altura = 50 ;
  ...
  //Guarda inicial
  $barras = '<img src='.$link.'/img/boleto_imgs/p.png width='.$fino.' height='.$altura.' border=0><img 
  src='.$link.'/img/boleto_imgs/b.png width='.$fino.' height='.$altura.' border=0><img 
  src='.$link.'/img/boleto_imgs/p.png width='.$fino.' height='.$altura.' border=0><img 
  src='.$link.'/img/boleto_imgs/b.png width='.$fino.' height='.$altura.' border=0><img ';
  ...
  while (strlen($texto) > 0) {
    ...
    for($i=1;$i<11;$i+=2){
      ...
      $barras .= 'src='.$link.'/img/boleto_imgs/p.png width='.$f1.' height='.$altura.' border=0><img ';
      ...
      $barras .= 'src='.$link.'/img/boleto_imgs/b.png width='.$f2.' height='.$altura.' border=0><img ';

    }
  }

  // Draw guarda final
  $barras .= 'src='.$link.'/img/boleto_imgs/p.png width='.$largo.' height='.$altura.' border=0><img 
  src='.$link.'/img/boleto_imgs/b.png width='.$fino.' height='.$altura.' border=0><img 
  src='.$link.'/img/boleto_imgs/p.png width=1 height='.$altura.' border=0>';
