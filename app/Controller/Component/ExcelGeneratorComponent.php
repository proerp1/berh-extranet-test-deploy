...
class ExcelGeneratorComponent extends Component
{
    ...
    public function gerarRelatorioComprasSimples($nome, $dados)
    {
        $spreadsheet = new Spreadsheet();

        $this->templates_list->getRelatorioComprasSimples($spreadsheet, $dados);
    ...
    public function gerarOperadorasDetalhes($nome, $dados)
    {
        $spreadsheet = new Spreadsheet();

        $this->templates_list->getOperadorasDetalhes($spreadsheet, $dados);
    ...
    public function gerarExcelCanais($nome, $dados)
    {
        $spreadsheet = new Spreadsheet();

        $this->templates_list->getCanais($spreadsheet, $dados);
