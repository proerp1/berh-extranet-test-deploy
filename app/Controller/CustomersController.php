...
class CustomersController extends AppController
{
    ...
    public $paginate = [
        ...
        'BillingMonthlyPayment' => ['limit' => 10,
            ...
            'joins' => [['table' => 'incomes',
                'alias' => 'Income',
                'type' => 'left',
                'conditions' => ['Income.billing_id = BillingMonthlyPayment.billing_id', 'Income.customer_id = BillingMonthlyPayment.customer_id']
            ],
                ['table' => 'statuses',
                    'alias' => 'StatusIncome',
                    'type' => 'LEFT',
                    'conditions' => ['StatusIncome.id = Income.status_id', 'Income.data_cancel' => '1901-01-01']
                ]
            ],
        ],
    ...
    ********************/
    public function index()
    {
        ...
        if (isset($_GET['exportar'])) {
            $nome = 'clientes_locaweb_'.date('d_m_Y_H_i_s').'.csv';
    ...
    public function add()
    {
        ...
        $sellers = $this->Seller->find('list', ['conditions' => ['Seller.status_id' => 1, 'Seller.resale_id' => CakeSession::read("Auth.User.resales")], 'order' => 'Seller.nome_fantasia']);
    ...
    public function duplicate($id)
    {
        ...
        unset($antigo['Customer']['id']);
        unset($antigo['Customer']['created']);
        unset($antigo['Customer']['user_creator_id']);
        unset($antigo['Customer']['updated']);
        unset($antigo['Customer']['user_updated_id']);
        ...
        if ($this->Customer->save($antigo, false)) {
            ...
            $customer_user = ['CustomerUser' => ['name' => $antigo['Customer']['nome_primario'],
    ...
    **********************/
    ...
    public function historico($id, $customer_id)
    {
        ...
        $this->set(compact('id', 'action', 'faturamento', 'faturamento_cliente', 'negativacao', 'pefin', 'customer_id', 'tipo', 'logons', 'breadcrumb'));
    }
