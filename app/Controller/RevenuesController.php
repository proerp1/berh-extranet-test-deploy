...
class RevenuesController extends AppController
{
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Revenue->validates()) {
                ...
                if ($this->Revenue->save($this->request->data)) {
                    $this->Flash->set(__('A receita foi salva com sucesso'), ['params' => ['class' => "alert alert-success"]]);
                    $this->redirect(['action' => 'index']);
                } else {
                    $this->Flash->set(__('A receita não pode ser salva, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
                }
            } else {
                $this->Flash->set(__('A receita não pode ser salva, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Revenue->save($this->request->data)) {
                $this->Flash->set(__('A receita foi alterada com sucesso'), ['params' => ['class' => "alert alert-success"]]);
                $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->set(__('A receita não pode ser alterada, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->Revenue->save($this->request->data)) {
            $this->Flash->set(__('A receita foi excluida com sucesso'), ['params' => ['class' => "alert alert-success"]]);
            $this->redirect(['action' => 'index']);
        }
    }
}
