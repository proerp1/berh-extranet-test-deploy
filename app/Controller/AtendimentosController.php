    ...
    public function view($id)
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Atendimento->save($this->request->data)) {
                $this->Session->setFlash(__('O atendimento foi alterado com sucesso'), 'default', ['class' => "alert alert-success"]);
                $this->redirect(['action' => 'index']);
            } else {
                $this->Session->setFlash(__('O atendimento não pode ser alterado, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
            }
        }
