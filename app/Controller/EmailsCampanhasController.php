    ...
    public function add()
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($save) {
                ...
                $this->Flash->set(__('Erro ao salvar a campanha, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
    ...
    public function edit($id)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->EmailsCampanha->save($this->request->data)) {
                $this->Flash->set(__('Campanha alterada com sucesso.'), ['params' => ['class' => "alert alert-success"]]);
            } else {
                $this->Flash->set(__('A campanha não pôde ser alterada, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
        ...
        if (!$send) {
            $this->Flash->set(__('Emails ainda não enviados'), ['params' => ['class' => "alert alert-danger"]]);
        }

        if ($send && $processing) {
            $buscar = false;
            $this->Flash->set(__('Os emails estão sendo enviados! Aguarde até o processo finalizar'), 'default', ['class' => "alert alert-warning"]);
        } elseif ($send && !$processing) {
            $buscar = false;
            $this->Flash->set(__('Processo de envio finalizado!'), ['params' => ['class' => "alert alert-success"]]);
        }
    ...
    ************************/
    public function list_emails($id)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            $this->Flash->set(__('Destinatários adicionados. Você já pode enviar a mensagem.'), ['params' => ['class' => "alert alert-success"]]);
    ...
    public function delete_email($id, $list_id)
    {
        ...
        if ($this->MailList->save($data)) {
            $this->Flash->set(__('O cliente foi excluido da lista com sucesso'), ['params' => ['class' => "alert alert-success"]]);
            $this->redirect(['action' => 'view_emails/'.$id]);
        }
    }
    ...
    ************************/
    public function send_emails($id)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            $this->Flash->set(__('Campanha programada com sucesso! Em breve o disparo será realizado.'), ['params' => ['class' => "alert alert-success"]]);
        }
