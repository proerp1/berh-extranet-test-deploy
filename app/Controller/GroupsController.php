...
class GroupsController extends AppController
{
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Group->validates()) {
                ...
                if ($this->Group->save($this->request->data)) {
                    $this->Flash->set(__('O grupo foi salvo com sucesso'), ['params' => ['class' => "alert alert-success"]]);
                    $this->redirect(['action' => 'edit/'.$this->Group->id]);
                } else {
                    $this->Flash->set(__('O grupo não pode ser salvo, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
                }
            } else {
                $this->Flash->set(__('O grupo não pode ser salvo, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($this->Group->save($this->request->data)) {
                $this->Flash->set(__('O grupo foi alterado com sucesso'), ['params' => ['class' => "alert alert-success"]]);
            } else {
                $this->Flash->set(__('O grupo não pode ser alterado, Por favor tente de novo.'), ['params' => ['class' => "alert alert-danger"]]);
            }
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->Group->save($this->request->data)) {
            $this->Flash->set(__('O grupo foi excluido com sucesso'), ['params' => ['class' => "alert alert-success"]]);
    ...
    public function alter_permission()
    {
        ...
        $this->Flash->set(__('A permissao foi alterada com sucesso'), ['params' => ['class' => "alert alert-success"]]);
