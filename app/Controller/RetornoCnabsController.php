...
class RetornoCnabsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->RetornoCnab->save($this->request->data)) {
                ...
                $this->Session->setFlash(__('Arquivo importado com sucesso!'), 'default', ['class' => "alert alert-success"]);
                $this->redirect(['action' => 'index']);
            } else {
                $this->Session->setFlash(__('O arquivo não pode ser salva, Por favor tente de novo.'), 'default', ['class' => "alert alert-danger"]);
            }
        }
    ...
    public function baixar_contas($id)
    {
        ...
        $this->Session->setFlash(__('Contas baixadas com sucesso'), 'default', ['class' => "alert alert-success"]);
        $this->redirect(['action' => 'index']);
    }
    ...
    public function delete($id)
    {
        ...
        if ($this->RetornoCnab->save($data)) {
            $this->Session->setFlash(__('O arquivo foi excluida com sucesso'), 'default', ['class' => "alert alert-success"]);
            $this->redirect(['action' => 'index']);
        }
    }
}
