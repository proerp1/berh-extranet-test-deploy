...
var KTChartsWidget23 = (function () {
  ...
  var initChart = function (response) {
    ...
    am5.ready(function () {
      ...
      for (let i = 0; i < response.data.length; i++) {
        response.data[i] = {...response.data[i], columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) }};
      }
  ...
  var initChartEconomia = function (response) {
    ...
    am5.ready(function () {
      ...
      for (let i = 0; i < response.data.length; i++) {
        response.data[i] = {...response.data[i], columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }};
      }
