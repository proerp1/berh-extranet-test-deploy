...
var KTChartsWidget32 = function () {
    ...
    var initChart = function(tabSelector, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['Comercial', 'RH', 'Logística', 'Operações', 'Produção', 'TI', 'Financeiro'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    return {
        init: function () {   
            initChart('#kt_charts_widget_32_tab_1', '#kt_charts_widget_32_chart_1', [100, 80, 75, 110, 50, 33, 47], true);
