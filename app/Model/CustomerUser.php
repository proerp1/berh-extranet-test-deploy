...
class CustomerUser extends AppModel
{
    ...
    public function find_pedido_beneficiarios_info($orderID, $pix = 'ambos')
    {
        ...
        $sql = "SELECT o.id, u.name, LPAD(REPLACE(u.cpf, '.', ''), 11, '0') as cpf, u.email, IFNULL(u.cel, u.tel) as telefone, k.name, k.code, CONCAT(b.branch_number, '-', b.branch_digit) AS agencia, CONCAT(b.acc_number, '-', b.acc_digit) AS conta, b.pix_type, b.pix_id, t.description, i.subtotal, i.total, i.id, i.pix_status_id
                    FROM orders o 
