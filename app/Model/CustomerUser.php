...
class CustomerUser extends AppModel
{
    ...
    {
        $sql = "SELECT u.name, u.cpf, k.name, CONCAT(b.branch_number, '-', b.branch_digit) AS agencia, CONCAT(b.acc_number, '-', b.acc_digit) AS conta, b.pix_type, b.pix_id, t.description, i.subtotal, i.total 
                    FROM orders o 
