...
<div class="card mb-5 mb-xl-8">
    <div class="card-body pt-7 py-3">
        ...
        <input type="hidden" name="data[CustomerUserBankAccount][customer_user_id]" value="<?php echo $id; ?>">
        ...
        <div class="row">
            ...
            <div class="mb-7 col">
                <label class="fw-semibold fs-6 mb-2 required">Nome Banco</label>
                <?php echo $this->Form->input('bank_name', array("id" => "bank_name", "placeholder" => "Nome Banco", "required" => false, "class" => "form-control mb-3 mb-lg-0"));  ?>
            </div>

            <div class="mb-7 col">
                <label class="fw-semibold fs-6 mb-2 required">Número Banco</label>
                <?php echo $this->Form->input('bank_code', array("id" => "bank_code", "placeholder" => "Número Banco", "required" => false, "class" => "form-control mb-3 mb-lg-0"));  ?>
            </div>
        </div>
