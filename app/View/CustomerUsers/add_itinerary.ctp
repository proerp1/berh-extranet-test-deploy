...
<div class="card mb-5 mb-xl-8">
    <div class="card-body pt-7 py-3">
        ...
        <div class="mb-7 col">
            ...
            <?php 
                echo $this->Form->input('status_id', ["class" => "form-select form-select-solid fw-bolder", "data-kt-select2" => "true", "empty" => false, 'options' => $statuses, 'default' => 1, 'required' => false ]); 
            ?>
        </div>
        ...
        <div class="row">
            ...
            <div class="mb-7 col">
                ...
                <?php echo $this->Form->input('price_per_day', array("id" => "price_per_day", 'type' => 'text', "placeholder" => "Valor por dia", "required" => true, "class" => "form-control mb-3 mb-lg-0 money_field", 'readonly' => true));  ?>
            </div>
        </div>
