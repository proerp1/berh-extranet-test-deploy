					...
					<?php if ($data) { ?>
						<?php for ($i=0; $i < count($data); $i++) { ?>
							<tr>
								...
								<td class="fw-bold fs-7"><a href="<?php echo $this->webroot.'files/atendimento/file_atendimento/'.$data[$i]["Atendimento"]["id"].'/'.$data[$i]["Atendimento"]["file_atendimento"]; ?>"><?php echo $data[$i]["Atendimento"]["file_atendimento"]; ?></a></td>
