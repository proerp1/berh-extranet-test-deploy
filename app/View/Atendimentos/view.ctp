	...
	<div class="card mb-5 mb-xl-8">
		...
		<div class="mb-7">
			...
			<div class="form-check form-check-inline d-block mt-2">
				<input class="form-check-input" type="radio" name="Atendimento[mostrar_cliente_option]" id="mostrar_cliente_sim" value="1" <?php echo $mostrar_cliente == 1 ? 'checked' : ''; ?> <?php echo $mostrar_cliente == 1 ? 'disabled' : ''; ?>>
				<label class="form-check-label" for="mostrar_cliente_sim">Sim</label>
			</div>
			<div class="form-check form-check-inline d-block mt-2">
				<input class="form-check-input" type="radio" name="Atendimento[mostrar_cliente_option]" id="mostrar_cliente_nao" value="0" <?php echo $mostrar_cliente == 0 ? 'checked' : ''; ?> <?php echo $mostrar_cliente == 1 ? 'disabled' : ''; ?>>
