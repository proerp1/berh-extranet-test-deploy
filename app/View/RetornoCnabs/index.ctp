<?php $url_novo = $this->base."/retorno_cnabs/add/"; ?>
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "retorno_cnabs", "action" => "index")); ?>/" role="form" id="busca" autocomplete="off">
                        ...
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4">
                                    ...
                                    <?php if ($data[$i]["Status"]["id"] == 39): ?>
                                        <a href="javascript:" onclick="verConfirm('<?php echo $this->base.'/retorno_cnabs/delete/'.$data[$i]["RetornoCnab"]["id"]; ?>');" rel="tooltip" title="Excluir" class="btn btn-danger btn-sm">
                                            Excluir
                                        </a>
                                    <?php endif ?>
                                </td>
