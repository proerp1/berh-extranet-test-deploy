<?php $url_novo = $this->base."/resales/add/"; ?>
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "resales", "action" => "index")); ?>" role="form" id="busca" autocomplete="off">
                        ...
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4">
                                    ...
                                    <a href="javascript:" onclick="verConfirm('<?php echo $this->base.'/resales/delete/'.$data[$i]["Resale"]["id"]; ?>');" rel="tooltip" title="Excluir" class="btn btn-danger btn-sm">
                                        Excluir
                                    </a>
                                </td>
                            </tr>
