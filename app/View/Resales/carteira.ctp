...
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "resales", "action" => "carteira", $resale_id)); ?>" role="form" id="busca" autocomplete="off">
                                ...
                                <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Selecione" data-allow-clear="true" name="v" id="v">
                                    ...
                                    <?php
                                        for($a = 0; $a < count($vendedor); $a++){
											$selected = "";
											if (isset($_GET["v"])) {
												if($vendedor[$a]['Seller']['id'] == $_GET["v"]){
													$selected = "selected";
												}
											}
											echo '<option value="'.$vendedor[$a]['Seller']['id'].'" '.$selected.'>'.$vendedor[$a]['Seller']['nome_fantasia'].'</option>';
										}
                                    ?>
                                </select>
                            </div>
