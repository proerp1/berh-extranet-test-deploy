...
<?php $url_novo = $this->base."/suppliers/add_document/".$id;  ?>
<?php
    $url = $this->here;
...
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "suppliers", "action" => "documents", $id)); ?>" role="form" id="busca" autocomplete="off">
                    ...
                    <?php if ($data) { ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4">
                                    <a href="<?php echo $this->base.'/suppliers/edit_document/'.$id.'/'.$data[$i]["Docsupplier"]["id"]; ?>" class="btn btn-info btn-sm">
                                        Editar
                                    </a>
                                    <a href="javascript:" onclick="verConfirm('<?php echo $this->base.'/suppliers/delete_document/'.$id.'/'.$data[$i]["Docsupplier"]["id"]; ?>');" rel="tooltip" title="Excluir" class="btn btn-danger btn-sm">
                                        Excluir
                                    </a>
                                </td>
                            </tr>
