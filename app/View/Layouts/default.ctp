...
<script>
	...
	$(document).ready(function(){
		...
		$(".datepicker").datepicker({format: 'dd/mm/yyyy', weekStart: 1, orientation: "bottom auto", autoclose: true, language: "pt-BR", todayHighlight: true, toggleActive: true});
		$(".datepickerMes").datepicker({format: "mm/yyyy", minViewMode: 1, orientation: "bottom auto", language: "pt-BR", autoclose: true});
		$(".input-daterange").datepicker({format: 'dd/mm/yyyy', multidate: false, weekStart: 1, autoclose: true, language: "pt-BR", todayHighlight: true, toggleActive: true, orientation: "auto"});
