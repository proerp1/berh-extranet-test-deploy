...
<div class="card mb-5 mb-xl-8">
    <div class="card-body pt-7 py-3">
        <?php echo $this->Form->create('Customer', array("id" => "js-form-submit", "action" => "/".$form_action."/", "method" => "post", 'inputDefaults' => ['div' => false, 'label' => false], 'enctype' => 'multipart/form-data')); ?>
            ...
            <div class="row">
                <div class="mb-7 col">
                    <label class="fw-semibold fs-6 mb-2 required">Canal</label>
            ...
            <div class="row">
                <div class="mb-7 col-12">
                    ...
                    <?php echo $this->Form->input('observacao_notafiscal', array("placeholder" => "Observação Notal fiscal", "id" => "summernote_notafiscal" , "class" => "form-control mb-3 mb-lg-0", "readonly" => !$canEditNfseObs));  ?>
                </div>
            </div>
