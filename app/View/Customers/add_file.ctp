                ...
                <div class="mb-7 col">
                    ...
                    <div class="col-sm-5">
                        <?php if (isset($this->request->data["CustomerFile"])): ?>
                            <br>
                            <a download href="<?php echo $this->base.'/files/customer_file/file/'.$this->request->data["CustomerFile"]["id"].'/'.$this->request->data["CustomerFile"]["file"] ?>"><?php echo $this->request->data["CustomerFile"]["file"] ?></a>
                        <?php endif ?>
                    </div>
                </div>
            </div>
