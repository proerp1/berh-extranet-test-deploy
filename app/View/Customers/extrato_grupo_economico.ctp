                ...
                <?php if ($data) { ?>
                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                        <tr>
                            ...
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["subtotal"],2,',','.'); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["transfer_fee"],2,',','.'); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["commission_fee"],2,',','.'); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["desconto"],2,',','.'); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["total"],2,',','.'); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["saldo"],2,',','.'); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo 'R$' . number_format($data[$i][0]["total_saldo"],2,',','.'); ?></td>
