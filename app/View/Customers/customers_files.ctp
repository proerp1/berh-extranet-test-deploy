                ...
                <?php if ($data) { ?>
                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                        <tr>
                            ...
                            <td class="fw-bold fs-7 ps-4"><?php echo $data[$i]["Criado"]["name"]; ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo (isset(($data[$i]["CustomerFile"]["data_finalizacao"])) ? date('d/m/Y H:i:s', strtotime($data[$i]["CustomerFile"]["data_finalizacao"])) : ''); ?></td>
                            <td class="fw-bold fs-7 ps-4"><?php echo $data[$i]["Finalizado"]["name"]; ?></td>
