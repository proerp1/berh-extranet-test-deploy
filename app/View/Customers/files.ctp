<?php $url_novo = $this->base."/customers/add_document/".$id;  ?>
...
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "customers", "action" => "files", $id)); ?>" role="form" id="busca" autocomplete="off">
                    ...
                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                        <tr>
                            ...
                            <td class="fw-bold fs-7 ps-4">
                                <a href="<?php echo $this->base . '/customers/edit_file/' .$id. '/' . $data[$i]["CustomerFile"]["id"] . '/?' . (isset($_SERVER['QUERY_STRING']) ? $_SERVER['QUERY_STRING'] : ''); ?>" class="btn btn-info btn-sm">
                                    Editar
                                </a>
                            </td>
                        </tr>
