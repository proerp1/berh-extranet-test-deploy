<?php $url_novo = $this->base."/customers/add_negativacao_cliente/".$id;  ?>
<?php
    echo $this->element("abas_customers", array('id' => $id));
?>
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "customers", "action" => "negativacoes_cliente", $id)); ?>" role="form" id="busca" autocomplete="off">
                    ...
                    <?php if ($data) { ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4">
                                    <a href="<?php echo $this->base.'/customers/edit_negativacao_cliente/'.$id.'/'.$data[$i]["CustomerPefin"]["id"]; ?>" class="btn btn-info btn-sm">Detalhes</a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
