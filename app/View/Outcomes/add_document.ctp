            ...
            <div class="mb-7 col">
                ...
                <div class="col-sm-5">
                    ...
                    <?php if (isset($this->request->data["Docoutcome"])): ?>
                        <br>
                        <a download href="<?php echo $this->base.'/files/document/file/'.$this->request->data["Docoutcome"]["id"].'/'.$this->request->data["Docoutcome"]["file"] ?>"><?php echo $this->request->data["Docoutcome"]["file"] ?></a>
                    <?php endif ?>
                </div>
            </div>
