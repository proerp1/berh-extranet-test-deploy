<?php $url_novo = $this->base."/billing_sales/faturar_revendas/".$id;  ?>
<?php
...
<div class="card mb-5 mb-xl-8">
    <div class="card-header border-0 pt-6 pb-6">
        ...
        <div class="card-toolbar">
            <?php if ($billing_sale['BillingSale']['faturado_revendas'] == 0 || $refaturar): ?>
                <a href="<?php echo $url_novo; ?>" class="btn btn-primary me-3" type="button">
            ...
            <?php echo $this->element("table"); ?>
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        <th class="ps-4 rounded-start">Revenda</th>
                        <th>Valor a pagar</th>
                        <th>Valor pago</th>
                        ...
                        <?php for ($i=0; $i < count($previsao); $i++) { ?>
                            ...
                            <tr>
                                <td class="fw-bold fs-7 ps-4">
                                    <?php echo $previsao[$i]["r"]["nome_fantasia"] ?>
                                ...
                                <td class="fw-bold fs-7 ps-4"> 
                                    <?php if ($billing_sale['BillingSale']['faturado_revendas'] == 1) { ?>
                                        <a href="<?php echo $this->base.'/billing_sales/detalhes_revenda/'.$id.'/'.$previsao[$i]["r"]["id"]; ?>" class="btn btn-info btn-xs">Detalhes</a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
