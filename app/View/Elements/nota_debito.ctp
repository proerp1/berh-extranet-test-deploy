...
<body>
    <div class="page">
        ...
        <div class="cell">
            <p class="m-0 p-10">REEMBOLSO DE PAGAMENTO REFERENTE A AQUISIÇÃO DE BENEFÍCIOS DE VALESTRANSPORTES, VALES-REFEIÇÃO, VALES-ALIMENTAÇÃO E SIMILARES PARA TERCEIROS. VALORES RELACIONADOS COM TAXA PELA PRESTAÇÃO DE SERVIÇO SERÃO RECONHECIDOS ATRAVÉS DE NOTA FISCAL SERVIÇOS. </p>
        </div>
        <div class="cell text-center">
            <b>PEDIDO(S):</b>
        </div>
