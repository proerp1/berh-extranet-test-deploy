...
<li class="nav-item">
		<a class="nav-link <?php echo $this->request->params['controller'] == 'benefits' && $this->request->params['action'] == 'edit' ? 'active' : '' ?>" href="<?php echo $this->base.'/benefits/edit/'.$id; ?>">Benefício</a>
	</li>
    <li class="nav-item">
