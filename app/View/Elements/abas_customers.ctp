<ul class="nav nav-tabs nav-line-tabs mb-5 fs-6">
	...
	<li class="nav-item">
		<a class="nav-link <?php echo in_array($this->request->params['action'], ['extrato', 'extrato_grupo_economico']) ? 'active' : '' ?>" href="<?php echo $this->base.'/customers/extrato/'.$id; ?>">Movimentação</a>
	</li>
	<li class="nav-item">
	...
	<li class="nav-item">
		<a class="nav-link <?php echo in_array($this->request->params['controller'], ['customer_benefit_codes']) ? 'active' : '' ?>" href="<?php echo $this->base.'/customer_benefit_codes/index/'.$id; ?>">De/Para Benefício</a>
	</li>
	<li class="nav-item">
