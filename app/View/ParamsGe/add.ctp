...
<div class="card mb-5 mb-xl-8">
    <div class="card-body pt-7">
        <?php echo $this->Form->create('ParamsGe', ['id' => 'js-form-submit', 'url' => ['controller' => 'params_ge', 'action' => $form_action, $id, isset($paramsGeId) ? $paramsGeId : ''], 'method' => 'post', 'inputDefaults' => ['div' => false, 'label' => false]]); ?>
            ...
            <div class="col-sm-offset-2 col-sm-9">
                <a href="<?php echo $this->base.'/params_ge/index/'.$id.'/'.(isset($_SERVER['QUERY_STRING']) ? $_SERVER['QUERY_STRING'] : ''); ?>" class="btn btn-light-dark">Voltar</a>
