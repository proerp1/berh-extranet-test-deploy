    ...
    <div class="col">
        <div class="card h-lg-100">
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    <span class="fw-bold fs-2x text-gray-800 lh-1 ls-n2 total-value" id="tpp-value">
                        <div class="spinner-border spinner-border-sm" role="status"></div>
                    </span>
                    <div class="m-0">
    ...
    <div class="col">
        <div class="card h-lg-100">
            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                ...
                <div class="d-flex flex-column my-7">
                    <span class="fw-bold fs-2x text-gray-800 lh-1 ls-n2 total-value" id="desconto-value">
                        <div class="spinner-border spinner-border-sm" role="status"></div>
                    </span>
                    <div class="m-0">
...
<script>
    ...
    function loadTotals() {
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    updateTotalsDisplay(response.totals);
                } else {
                    showTotalsError();
                }
            },
    ...
    function updateTotalsDisplay(totals) {
        ...
        $('#economia-value').text(formatMoney(totals.total_economia));
