            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-7 col">
                        ...
                        <?php echo $this->Form->input('price_per_day', array("id" => "price_per_day", 'type' => 'text', "placeholder" => "Valor por dia", "required" => true, "class" => "form-control mb-3 mb-lg-0 money_field", 'readonly'));  ?>
                    </div>
                </div>
