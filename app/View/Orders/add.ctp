...
<div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-7 col-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                <input type="text" name="data[Order][due_date]" id="OrderDueDate" required class="form-control" value="<?php echo $order['Order']['due_date']; ?>" <?php echo $order['Order']['status_id'] != 83 ? 'disabled="disabled"' : ''; ?>>
                            </div>
    ...
    <div class="mb-12 col" style="text-align: right; margin-bottom: 10px !important;">
        ...
        <div class="dropdown">
            ...
            <!-- Dropdown menu com botões ajustados verticalmente -->
