                ...
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center h-md-100 mb-5 mb-xl-10" style="background-color: #080655;background-image:url('assets/media/svg/shapes/wave-bg-dark.svg')">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            <!--begin::Amount-->
                            <span class="fs-2hx fw-bolder text-white me-2 lh-1 ls-n2">R$ 5.895,43</span>
                            <!--end::Amount-->
                            <!--begin::Subtitle-->
                            <span class="text-white opacity-50 pt-1 fw-bold fs-6">Saldo para o dia 17/02/2021</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                ...
                <div class="card card-flush mb-5 mb-xl-10 h-md-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            <!--begin::Number-->
                            <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">R$85K</span>
                            <!--end::Number-->
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Limite Diário</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
            ...
            <div class="col-md-4 mb-md-5 mb-xl-10">
                ...
                <div class="card card-flush mb-5 mb-xl-10 h-md-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            <!--begin::Number-->
                            <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">R$40K</span>
                            <!--end::Number-->
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Utilizado</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
            ...
            <div class="col-md-4 mb-md-5 mb-xl-10">
                ...
                <div class="card card-flush mb-5 mb-xl-10 h-md-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            <!--begin::Number-->
                            <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">R$13K</span>
                            <!--end::Number-->
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Reprogramar Pagamento</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
            ...
            <div class="col-md-4 mb-md-5 mb-xl-10">
                ...
                <div class="card card-flush mb-5 mb-xl-10 h-md-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            <!--begin::Number-->
                            <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">6</span>
                            <!--end::Number-->
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Orçamentos</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
        ...
        <div class="card h-md-100">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder text-dark">Programação</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Total 424.567 compras</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                ...
                <ul class="nav nav-stretch nav-pills nav-pills-custom nav-pills-active-custom d-flex justify-content-between mb-8 px-5">
                    ...
                    <li class="nav-item p-0 ms-0">
                        ...
                        <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_1">
                            <span class="fs-7 fw-bold">Se</span>
                    ...
                    <li class="nav-item p-0 ms-0">
                        ...
                        <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_3">
                            <span class="fs-7 fw-bold">Do</span>
                    ...
                    <li class="nav-item p-0 ms-0">
                        ...
                        <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_5">
                            <span class="fs-7 fw-bold">Te</span>
                    ...
                    <li class="nav-item p-0 ms-0">
                        ...
                        <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_6">
                            <span class="fs-7 fw-bold">Qua</span>
                    ...
                    <li class="nav-item p-0 ms-0">
                        ...
                        <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_7">
                            <span class="fs-7 fw-bold">Qui</span>
                    ...
                    <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_1">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <!--end::Time-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6">Ligar para Leads</div>
                                <!--end::Description-->
                                <!--begin::Link-->
                                <div class="text-gray-400 fw-bold fs-7">Responsável
                                    <!--begin::Name-->
                                    <a href="#" class="text-primary opacity-75-hover fw-bold">Vendedor José</a>
                                    <!--end::Name-->
                                </div>
                                <!--end::Link-->
                            </div>
                            <!--end::Info-->
                            <!--begin::Action-->
                            <a href="#" class="btn btn-sm btn-light" data-bs-toggle="modal" data-bs-target="#kt_modal_create_project">Ver</a>
                            <!--end::Action-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Wrapper-->
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <!--end::Time-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6">Reunião Interna</div>
                                <!--end::Description-->
                                <!--begin::Link-->
                                <div class="text-gray-400 fw-bold fs-7">Responsável
                                    <!--begin::Name-->
                                    <a href="#" class="text-primary opacity-75-hover fw-bold">Vendedor João</a>
                                    <!--end::Name-->
                                </div>
                                <!--end::Link-->
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <!--end::Time-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6">Pós-Venda Empresa X</div>
                                <!--end::Description-->
                                <!--begin::Link-->
                                <div class="text-gray-400 fw-bold fs-7">Responsável
                                    <!--begin::Name-->
                                    <a href="#" class="text-primary opacity-75-hover fw-bold">Maria Vendedora</a>
                                    <!--end::Name-->
                                </div>
                                <!--end::Link-->
                            </div>
                    ...
                    <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_2">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <!--end::Description-->
                                <!--begin::Link-->
                                <div class="text-gray-400 fw-bold fs-7">Reponsável
                                    <!--begin::Name-->
                                    <a href="#" class="text-primary opacity-75-hover fw-bold">Mark Morris</a>
                                    <!--end::Name-->
                                </div>
                                <!--end::Link-->
                            </div>
                    ...
                    <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_3">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <div class="text-gray-400 fw-bold fs-7">Reponsável
                                    <!--begin::Name-->
                                    <a href="#" class="text-primary opacity-75-hover fw-bold">Bob</a>
                                    <!--end::Name-->
                                </div>
                                <!--end::Link-->
                            </div>
