<?php $url_novo = $this->base."/plano_contas/add/3/".$pai_id."?".(isset($_SERVER['QUERY_STRING']) ? $_SERVER['QUERY_STRING'] : ''); ?>
	...
	<section class="panel panel-default">
		<div class="panel-heading">
			...
			<div class="row">
				...
				<form class="col-md-8 col-lg-6" action="<?php echo $this->Html->url(array( "controller" => "plano_contas/index3/3/$pai_id", "action" => "index")); ?>/" role="form" id="busca">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
