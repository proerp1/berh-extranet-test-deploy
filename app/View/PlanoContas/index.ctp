<?php $url_novo = $this->base."/plano_contas/add/?".(isset($_SERVER['QUERY_STRING']) ? $_SERVER['QUERY_STRING'] : ''); ?>
	...
	<section class="panel panel-default">
		<div class="panel-heading">
			<div class="row">
				...
				<form class="col-md-8 col-lg-6" action="<?php echo $this->Html->url(array( "controller" => "plano_contas", "action" => "index")); ?>/" role="form" id="busca">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
					...
					<?php if ($data){ ?>
						<?php for ($i=0; $i < count($data); $i++) { ?>
							<tr>
								...
								<td><?php echo $data[$i]["PlanoConta"]["nivel"] == 1 ? 'Primeiro' : 'Segundo'; ?></td>
								<td>
