    ...
    <div class="card-body pt-0 py-3">
        <div class="table-responsive">
            <?php echo $this->element("table"); ?>
                ...
                <tbody>
                    ...
                    <?php if ($data) { ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <?php $saldo = $data[$i][0]['operador'] == '+' ? $saldo + $data[$i]['o']['valor_total'] : $saldo - $data[$i]['o']['valor_total'] ?>
                            <tr>
                                <td class="fw-bold fs-7 ps-4">
                                    <span class='label <?php echo $data[$i]["s"]["status_label"] ?>'>
                                        <?php echo $data[$i]["s"]["status"] ?>
                                    </span>
                                </td>
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i]['b']['name'] ?></td>
                                <td class="fw-bold fs-7 ps-4"><?php echo date('d/m/Y', strtotime($data[$i]['o']['vencimento'])) ?></td>
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i][0]['operador'].' '.number_format($data[$i]['o']['valor_total'],2,',','.') ?></td>
                ...
                <tfoot>
                    <th colspan="4" class="fw-bold fs-7 ps-4">Total:</th>
