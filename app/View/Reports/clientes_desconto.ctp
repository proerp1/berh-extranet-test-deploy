<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "reports", "action" => "clientes_desconto")); ?>" role="form" id="busca" autocomplete="off">
                    ...
                    <?php if ($data) { ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4">
                                    <a href="<?php echo $this->base.'/customers/edit/'.$data[$i]["Customer"]["id"]; ?>" class="btn btn-info btn-sm">
                                        Editar
                                    </a>
                                </td>
                            </tr>
