<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "reports", "action" => "bloqueio_diario")); ?>" role="form" id="busca" autocomplete="off">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-400px" data-kt-menu="true" id="kt-toolbar-filter">
                        ...
                        <div class="px-7 py-5">
                            <div class="mb-10">
                                <label class="form-label fs-5 fw-bold mb-3">Data alteração:</label>
            ...
            <?php echo $this->element("table"); ?>
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        <th class="ps-4 w-200px min-w-200px rounded-start">Código do associado</th>
                        <th>Razão social</th>
                        <th>Nome fantasia</th>
                        <th>Status atual</th>
                        <th>Data alteração</th>
                        <th class="w-150px min-w-150px rounded-end">Status antigo</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if ($data){ ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                <td class="fw-bold fs-7 ps-4">
                                    <a href="<?php echo $this->Html->url(['controller' => 'customers', 'action' => 'edit', $data[$i]["Customer"]["id"]]) ?>"><?php echo $data[$i]["Customer"]["codigo_associado"]; ?></a>
                                </td>
                                ...
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i]["Customer"]["Status"]["name"]; ?></td>
