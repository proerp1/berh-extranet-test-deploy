<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "reports", "action" => "string")); ?>" role="form" id="busca" autocomplete="off">
                    ...
                    <?php if ($data) { ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i][0]["tipo_campo"] ?></td>
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i][0]["campo"] ?></td>
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i][0]['features'] ?></td>
                                <td class="fw-bold fs-7 ps-4"><?php echo date('d/m/Y H:i:s', strtotime($data[$i]['NovaVidaLogConsulta']['created'])) ?></td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
                        <tr>
