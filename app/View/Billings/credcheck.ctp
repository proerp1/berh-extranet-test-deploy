                    ...
                    <?php if ($data) { ?>
                        <?php for ($i=0; $i < count($data); $i++) { ?>
                            <tr>
                                ...
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i]['BillingNovaVida']['quantidade'] ?></td>
                                <td class="fw-bold fs-7 ps-4"><?php echo $data[$i]['BillingNovaVida']['quantidade_cobrada'] ?></td>
                                <td class="fw-bold fs-7 ps-4">R$ <?php echo number_format($data[$i]['BillingNovaVida']['valor_unitario'],2,',','.') ?></td>
                                <td class="fw-bold fs-7 ps-4">R$ <?php echo number_format($data[$i]['BillingNovaVida']['valor_total'],2,',','.') ?></td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
                        <tr>
