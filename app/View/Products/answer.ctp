	...
	<section class="panel panel-default">
   	<div class="panel-heading">
			<div class="row">
				...
				<form class="col-md-8 col-lg-6" action="<?php echo $this->Html->url(array( "controller" => "products", "action" => "answer")); ?>/<?php echo $id; ?>" role="form" id="busca">
					<div class="row">
						<div class="col-md-4">
	          </div>
			  ...
			  <tbody>
					<?php if ($data) { ?>
						<?php for ($i=0; $i < count($data); $i++) { ?>
							<tr>
								<td><?php echo $data[$i]["Answer"]["name"]; ?></td>
								<td><?php echo $data[$i]["Answer"]["visivel_cliente"] == 1 ? "Sim" : "Não"; ?></td>
								<td>
									<a href="<?php echo $this->base; ?>/products/edit_answer/<?php echo $id ?>/<?php echo $data[$i]["Answer"]["id"]; ?>" class="btn btn-info btn-xs">
