   	...
   	<div class="panel-heading">
			<div class="row">
				<div class="col-md-4 col-lg-6">
					<?php $url_novo = $this->base."/products/add_feature/".$id; ?>						
				...
				<form class="col-md-8 col-lg-6" action="<?php echo $this->Html->url(array( "controller" => "products", "action" => "features")); ?>/<?php echo $id; ?>" role="form" id="busca">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
			  ...
			  <tbody>
			  	<?php if ($data) { ?>
	                  ...
	                  <?php echo $data[$i]["Status"]["name"] ?>
								...
								<td><?php echo $data[$i]["Feature"]["name"]; ?></td>
								<td><?php echo $data[$i]["Feature"]["valor"]; ?></td>
								<td><?php echo $data[$i]["Feature"]["valor_minimo"]; ?></td>
								<td>
									<a href="<?php echo $this->base; ?>/products/edit_feature/<?php echo $id ?>/<?php echo $data[$i]["Feature"]["id"]; ?>" class="btn btn-info btn-xs">
										<i class="fa fa-edit"></i>
									</a>
									<a href="javascript:" onclick="verConfirm('<?php echo $this->base; ?>/products/delete_feature/<?php echo $id ?>/<?php echo $data[$i]["Feature"]["id"]; ?>');" rel="tooltip" title="Excluir" class="btn btn-danger btn-xs">
