...
<div class="card mb-5 mb-xl-8">
    <form action="<?php echo $this->Html->url(array( "controller" => "boletos", "action" => "index")); ?>/" role="form" id="busca" autocomplete="off">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-400px" data-kt-menu="true" id="kt-toolbar-filter">
                        ...
                        <div class="px-7 py-5">
                            <div class="mb-10">
                                <label class="form-label fs-5 fw-bold mb-3">Boleto gerado?</label>
...
<div class="modal fade" tabindex="-1" id="modal_gerar_arquivo" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo $this->base.'/boletos/emitir' ?>" class="form-horizontal" method="post">
                <input type="hidden" name="ids" id="income_ids">
                <div class="modal-body">
                    <p>Tem certeza que deseja emitir os boletos para esse(s) cliente(s)?</p>
